...
HW_PRAC_01_06PO <- function(VCP = "HW_PRAC_01_06PO"){
  ...
  if (VCQI_MAKE_UW_PLOTS == 1){
    ...
    vcqi_to_uwplot_MV(database = paste0(VCQI_OUTPUT_FOLDER,"/HW_PRAC_01_",ANALYSIS_COUNTER,"_0_database.rds"),
                   title = title0,
    ...
    vcqi_to_uwplot_MV(database = paste0(VCQI_OUTPUT_FOLDER,"/HW_PRAC_01_",ANALYSIS_COUNTER,"_1_database.rds"),
                   title = title1,
    ...
    vcqi_to_uwplot_MV(database = paste0(VCQI_OUTPUT_FOLDER,"/HW_PRAC_01_",ANALYSIS_COUNTER,"_2_database.rds"),
                   title = title2,
    ...
    vcqi_to_uwplot_MV(database = paste0(VCQI_OUTPUT_FOLDER,"/HW_PRAC_01_",ANALYSIS_COUNTER,"_3_database.rds"),
                   title = title3,
    ...
    vcqi_to_uwplot_MV(database = paste0(VCQI_OUTPUT_FOLDER,"/HW_PRAC_01_",ANALYSIS_COUNTER,"_4_database.rds"),
                   title = title4,
