...
# vcqi_to_uwplot_MV R version 1.07 - Biostat Global Consulting - 2023-08-21
# *******************************************************************************
# Change log
...
vcqi_to_uwplot_MV <- function(
  ...
  if (IWPLOT_SHOWBARS == 1){
    ...
    baseplot <- baseplot +
      ...
      coord_flip() +
      labs(y = language_string(language_use = language_use, str = "OS_68"),x = "",title = title,caption = note) +
