...
HW_PRAC_01_04GO <- function(VCP = "HW_PRAC_01_04GO"){
  ...
  make_unwtd_output_database_MV(variable = "improper_practices_none",
                             estlabel = "No Improper Vx Practices",
                             vid = 0,
                             measureid = "HW_PRAC_01")
  print("Improper Vx practices - Part 1")
  make_unwtd_output_database_MV(variable = "improper_practices_1",
                             estlabel = "Improper Vx Practices - Part 1",
                             vid = 1,
                             measureid = "HW_PRAC_01")
  print("Improper Vx practices - Part 2")
  make_unwtd_output_database_MV(variable = "improper_practices_2",
                             estlabel = "Improper Vx Practices - Part 2",
                             vid = 2,
                             measureid = "HW_PRAC_01")
  print("Improper Vx practices - Any")
  make_unwtd_output_database_MV(variable = "improper_practices_any",
                             estlabel = "Any Improper Vx Practices",
                             vid = 3,
                             measureid = "HW_PRAC_01")
  print("Improper Vx practices - Both")
  make_unwtd_output_database_MV(variable = "improper_practices_both",
